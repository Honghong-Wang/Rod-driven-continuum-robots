...
Before uploading this folder to GitHub, check the following:

- No `.m`, `.mlx`, `.mat`, `.fig`, `.slx`, or internal source files are included.
...
`rod-driven-continuum-robot-public-media`
